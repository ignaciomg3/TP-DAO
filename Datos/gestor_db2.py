...
class GestorDB:
        ...
        try:
            ...
            cursor.execute('''
                CREATE TABLE IF NOT EXISTS Habitacion (
                    ...
                    FOREIGN KEY (tipo_habitacion) REFERENCES tipo_habitacion(id_tipo_h),
                    FOREIGN KEY (estado) REFERENCES estado_habitacion(id_tipo_estado)
                )
            ''')
            # Crear tabla tipo Habitacion
            cursor.execute('''
                CREATE TABLE IF NOT EXISTS tipo_habitacion (
                    id_tipo_h INTEGER PRIMARY KEY,
                    tipo TEXT NOT NULL
                )
            ''')
            # Crear tabla Estado Habitacion 
            cursor.execute('''
                CREATE TABLE IF NOT EXISTS estado_habitacion (
                    id_tipo_estado INTEGER PRIMARY KEY,
    ...
    def obtener_habitaciones(self):
        ...
        print("Habitaciones mostradas correctamente.")
